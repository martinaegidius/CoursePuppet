...
You can find an **important** description of the theory behind LDA in: [Exercise theory](https://github.com/RasmusRPaulsen/DTUImageAnalysis/blob/main/exercises/ex6b-AdvancedPixelClassification/theory/Exercise6b_2023_Theory.pdf).
