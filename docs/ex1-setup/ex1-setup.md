...
Please see [Figures in Notebooks](https://dtuimageanalysisorg.github.io/DTUImageAnalysis/setup/figs_in_nbs) for details on figures in notebooks.
...
The data and material needed for this exercise can be found here: [exercise data and material](https://github.com/RasmusRPaulsen/DTUImageAnalysis/tree/main/exercises).
